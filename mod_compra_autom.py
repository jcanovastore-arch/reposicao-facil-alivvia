# mod_compra_autom.py - TAB 2 - V9.1
# - Corrige 'painl' -> 'painel'
# - data_editor resiliente (usa retorno do widget e fallback p/ session_state)
# - checagens defensivas de colunas
...
def render_tab2(state, h, g, LT):
    ...
    if nome_estado in state.compra_autom_data and "df" in state.compra_autom_data[nome_estado]:
        ...
        # Preferir DataFrame de retorno do widget (Streamlit recente)
        ...
        # Descobrir selecionados (widget novo ou fallback antigo)
